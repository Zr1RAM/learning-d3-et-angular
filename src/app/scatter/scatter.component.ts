...
export class ScatterComponent implements OnInit, AfterViewInit {
  ...
  /**
   * method to create the x- and y-axes of your plot and add the dots to the canvas.
   *  This method makes the points semi-transparent and adds the name of each framework
   *  as a label.
   */
  private drawPlot(): void {
    ...
    const zoom = d3.zoom<SVGSVGElement, unknown>()
      .scaleExtent([1, 15]) // how much you can zoom
      .extent([
        [0, 0],
